...
export default function ShipGame() {
  return (
    <>
      ...
      <p className="blog-link" id="link-text">
        Links:
      </p>
      <a
      ...
      <p>
        <a
          href="https://codesandbox.io/s/react-fox-a-react-three-fiber-scene-part-three-game-state-and-sprites-b7e01?file=/src/App.js:525-527"
          className="blog-link"
          id="code-link"
          target="_blank"
          rel="noopener noreferrer"
        ...
        provided by Code Workshop on{' '}
        <a
          href="https://youtube.com/watch?v=ADBnmJ1Z_18"
          className="blog-link"
          id="yt-link"
          target="_blank"
          rel="noopener noreferrer"
